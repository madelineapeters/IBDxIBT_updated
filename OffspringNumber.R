...
ggplot()+geom_line(data=filter(Ne.joint,run==1),aes(x=Gen,y=var,col=Isolation),alpha=0.25)+
  ...
  geom_line(data=filter(Ne.joint,run==5),aes(x=Gen,y=var,col=Isolation),alpha=0.25)+
  geom_line(data=filter(Ne.joint,run==6),aes(x=Gen,y=var,col=Isolation),alpha=0.25)+
  geom_line(data=filter(Ne.joint,run==8),aes(x=Gen,y=var,col=Isolation),alpha=0.25)+
